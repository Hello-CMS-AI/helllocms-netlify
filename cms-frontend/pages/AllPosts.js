...
const AllPosts = () => {
  ...
  useEffect(() => {
    // Distinct authors
    fetch('https://hellocms.dinasuvadu.com:5000/api/posts/distinct-authors')
      .then((res) => res.json())
      .then((data) => {
    ...
    // Categories
    fetch('https://hellocms.dinasuvadu.com:5000/api/categories/list-categories')
      .then((res) => res.json())
      .then((data) => {
        setCategories(data);
  ...
  const fetchPosts = async () => {
    try {
      ...
      const res = await fetch(`https://hellocms.dinasuvadu.com:5000/api/posts?${queryParams.toString()}`);
  ...
  const handleTrash = async (postId) => {
    try {
      const res = await fetch(`https://hellocms.dinasuvadu.com:5000/api/posts/${postId}`, {
        method: 'PUT',
  ...
  const handleView = (record) => {
    ...
    let baseURL = 'https://hellocms.dinasuvadu.com:3000'; 
  ...
  const handlePreview = (postId) => {
    window.open(`https://hellocms.dinasuvadu.com:3000/preview/${postId}`, '_blank');
  };
